#	This program should be executed as ./ProjectTests/test-002-use_after_free.sh
#	not as ./test-002-use_after_free.sh
...
then
	...
	python additive_log_parse.py asan_log.log ProjectGitRepo/lowlevel_service.c ProjectTests/test-002-use_after_free.sh json/use_after_free.json
else
